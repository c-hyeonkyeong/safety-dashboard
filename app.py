        ...
        with st.form("worker_main_form_final_v4"):
            ...
            edited_df = st.data_editor(
                ...
                column_config={
                    ...
                    "신규교육_이수": st.column_config.CheckboxColumn("신규이수"),
                    "공통8H": st.column_config.CheckboxColumn("공통8H"),
                    "과목1_온라인4H": st.column_config.CheckboxColumn("1-온라인"),
                    "과목1_감독자4H": st.column_config.CheckboxColumn("1-감독자"),
                    "과목2_온라인4H": st.column_config.CheckboxColumn("2-온라인"),
                    "과목2_감독자4H": st.column_config.CheckboxColumn("2-감독자")
                }
            )
            
            if st.form_submit_button("명부 수정사항 적용", type="primary"):
        ...
        with st.form("new_hire_form_final"):
            edited_target = st.data_editor(
                ...
                column_config={
                    ...
                    "담당관리감독자": st.column_config.TextColumn(disabled=True)
                }
            )
            if st.form_submit_button("변경사항 적용"):
        ...
        with st.form("special_edu_form_final"):
            edited_target = st.data_editor(
                ...
                column_config={
                    ...
                    "공통8H": st.column_config.CheckboxColumn("공통 8H"),
                    "과목1_온라인4H": st.column_config.CheckboxColumn("과목1-온라인"),
                    "과목1_감독자4H": st.column_config.CheckboxColumn("과목1-감독자"),
                    "과목2_온라인4H": st.column_config.CheckboxColumn("과목2-온라인"),
                    "과목2_감독자4H": st.column_config.CheckboxColumn("과목2-감독자"),
                }
            )
            if st.form_submit_button("변경사항 적용"):
